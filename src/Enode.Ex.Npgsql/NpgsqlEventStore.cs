    ...
    public class NpgsqlEventStore : IEventStore
    {
        ...
        private void BulkInsert(NpgsqlConnection connection, string aggregateRootId, StreamRecord[] eventStreamList)
        {
            ...
            do
            {
                ...
                {
                    var commandFormat = string.Format(CultureInfo.InvariantCulture, "COPY \"EventStream\" (\"AggregateRootTypeName\",\"AggregateRootId\",\"Version\",\"CommandId\",\"CreatedOn\",\"Events\") FROM STDIN BINARY");
